...
const (
	TripService_CreateTrip_FullMethodName = "/trip.v1alpha1.TripService/CreateTrip"
)
...
type TripServiceClient interface {
	// Create a new trip with ride fare information
...
var TripService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "trip.v1alpha1.TripService",
